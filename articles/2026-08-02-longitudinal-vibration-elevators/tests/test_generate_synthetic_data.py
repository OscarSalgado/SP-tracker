...
def test_get_default_parameters():
    ...
    required_keys = {
        'm_motor', 'm_traction', 'm_car_frame', 'm_cabin', 'm_counterweight',
        'k_rope_car', 'k_rope_counter', 'k_isolation', 'rope_stiffness',
        'c_rope_car', 'c_rope_counter', 'c_isolation', 'damping'
    }
